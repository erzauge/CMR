 ...
 */
template<typename T>
std::ostream& binary_write(std::ostream& stream, const T& value,unsigned long long int n){
 ...
 */
template<typename T>
std::istream & binary_read(std::istream& stream, T& value, unsigned long long int n){
